package com.example.dila.ernadila_1202154308_studycase4;
...
public class ImageAsynkTask extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_image_asynk_task);
    ...
    class LoadImage extends AsyncTask<Void, Void, Bitmap> {
        ...
        protected void onPostExecute(Bitmap bitmap) {
            ...
            if (bitmap != null){
                ...
                Toast.makeText(ImageAsynkTask.this, "Link Salah", Toast.LENGTH_LONG).show();
            }
        }
    }
